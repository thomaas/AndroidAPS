...
internal class DelegatedEffectiveProfileSwitchDao(changes: MutableList<DBEntry>, dao: EffectiveProfileSwitchDao) : DelegatedDao(changes), EffectiveProfileSwitchDao by dao {
